...
// Si le membre visite son profil, ou si le membre est administrateur
if($pun_user['id'] == $_GET['id'] OR $pun_user['g_id'] <= '2')
{
...
// Sinon, c'est que le membre visite le profil d'un autre membre
else
{
?>
						<dl>
							<dt><?php echo $lang_exemple['Plugile name']; ?>: </dt>
							<dd>
								<div><p><?php echo $lang_exemple['Plugile description 1']; ?></p></div>
							</dd>
						</dl>
